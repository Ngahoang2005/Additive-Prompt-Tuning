...
class iStanfordCars(iIMAGENET_R):
    base_folder = 'StanfordCars'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/stanfordcars_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/stanfordcars_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']

class iStanfordDogs(iIMAGENET_R):
    base_folder = 'StanfordDogs'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/stanforddogs_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/stanforddogs_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']

class iEuroSAT(iIMAGENET_R):
    base_folder = 'EuroSAT'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/eurosat_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/eurosat_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']

class iCropDisease(iIMAGENET_R):
    base_folder = 'CropDisease'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/cropdisease_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/cropdisease_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']

class iISIC(iIMAGENET_R):
    base_folder = 'ISIC'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/isic_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/isic_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']

class iRESISC45(iIMAGENET_R):
    base_folder = 'RESISC45'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/resisc_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/resisc_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']

class iNABirds(iIMAGENET_R):
    base_folder = 'nabirds'
    im_size=224
    nch=3
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/nabirds_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/nabirds_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']
...
class iCUB200(iIMAGENET_R):
    ...
    def load(self):
        ...
        # load splits from config file
        if self.train or self.validation:
            data_config = yaml.load(open('dataloaders/splits/cub200_train.yaml', 'r'), Loader=yaml.Loader)
        else:
            data_config = yaml.load(open('dataloaders/splits/cub200_test.yaml', 'r'), Loader=yaml.Loader)
        self.data = data_config['data']
        self.targets = data_config['targets']
