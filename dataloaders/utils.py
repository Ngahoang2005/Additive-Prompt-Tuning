...
def get_transform(dataset='cifar100', phase='test', aug=True, resize_imnet=False):
    ...
    if phase == 'train':
        if dataset == 'cifar100':
            transform_list.extend([
                T.AutoAugment(T.AutoAugmentPolicy.CIFAR10, bilinear),
        ...
        if dataset.startswith('ImageNet') or dataset == 'DomainNet' or dataset == 'StanfordCars' or dataset == 'CUB200' or dataset == 'StanfordDogs' or dataset == 'NABirds' or dataset == 'EuroSAT' or dataset == 'ISIC' or dataset == 'RESISC45' or dataset == 'CropDisease':
            transform_list.extend([
